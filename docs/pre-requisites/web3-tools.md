...
### Tokens
[**What are tokens? | Simply Explained**](https://www.coinbase.com/learn/crypto-basics/what-is-a-token)
In the web3 world, the word [token](https://www.coinbase.com/learn/crypto-basics/what-is-a-token) is synonumous with _coin_ or a way to refer to a type of cryptocurrency.  
